...
1. [Additional types of Expansion Compute Nodes are available.](https://github.com/IBM-Blue-Box-Help/help-documentation/new/gh-pages/_gettingstarted/release_notes_for_customers.md/#additional-types-of-expansion-compute-nodes-now-available)
