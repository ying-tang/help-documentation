...
Check [Package List](http://localhost:4000/help-documentation/pathchlist/centos-6.8/) to see a full list of all upgraded/installed packages.

Check [Package List](http://localhost:4000/help-documentation/patchlist/centos-7.2/) to see a full list of all upgraded/installed packages.