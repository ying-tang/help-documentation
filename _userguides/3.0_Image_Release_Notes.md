...
Check [Package List](http://ibm-blue-box-help.github.io/help-documentation/gettingstarted/userguides/3.0_image_patch_list/centos-6.8/) to see a full list of all upgraded/installed packages.